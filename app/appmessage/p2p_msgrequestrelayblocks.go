...
// MsgRequestRelayBlocks implements the Message interface and represents a hoosat
...
// NewMsgRequestRelayBlocks returns a new hoosat RequestRelayBlocks message that conforms to
