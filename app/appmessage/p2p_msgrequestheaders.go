...
// MsgRequestHeaders implements the Message interface and represents a hoosat
...
// NewMsgRequstHeaders returns a new hoosat RequestHeaders message that conforms to the
