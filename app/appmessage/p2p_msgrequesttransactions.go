...
// MsgRequestTransactions implements the Message interface and represents a hoosat
...
// NewMsgRequestTransactions returns a new hoosat RequestTransactions message that conforms to
