...
// MsgTransactionNotFound defines a hoosat TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new hoosat transactionsnotfound message that conforms to the
