...
// MsgRequestAnticone implements the Message interface and represents a hoosat
...
// NewMsgRequestAnticone returns a new hoosat RequestPastDiff message that conforms to the
