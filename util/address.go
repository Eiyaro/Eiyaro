...
const (
	...
	Bech32PrefixEiyaroDev

	// Prefix for the test network.
	Bech32PrefixEiyaroTest

	// Prefix for the simulation network.
	Bech32PrefixEiyaroSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"eiyaro":     Bech32PrefixEiyaro,
	"eydev":      Bech32PrefixEiyaroDev,
	"eiyarotest": Bech32PrefixEiyaroTest,
	"eiyarosim":  Bech32PrefixEiyaroSim,
}
...
// and a payload which encodes the hoosat network and address type. It is used
