...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Eiyaro-Project/EYAROD/database)

Package database provides a database for eiyarod.
...
DataAccessor
------------
This defines the common interface by which data gets accessed in a generic eiyarod
...
Transaction
-----------
This defines the interface of a generic eiyarod database transaction.
