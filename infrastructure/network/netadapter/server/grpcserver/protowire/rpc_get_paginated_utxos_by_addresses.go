...
func (x *EiyaroMessage_GetPaginatedUtxosByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "EiyaroMessage_GetPaginatedUtxosByAddressesRequest is nil")
	}
	return x.GetPaginatedUtxosByAddressesRequest.toAppMessage()
}

func (x *EiyaroMessage_GetPaginatedUtxosByAddressesRequest) fromAppMessage(message *appmessage.GetPaginatedUTXOsByAddressesRequestMessage) error {
...
func (x *EiyaroMessage_GetPaginatedUtxosByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *EiyaroMessage_GetPaginatedUtxosByAddressesResponse) fromAppMessage(message *appmessage.GetPaginatedUTXOsByAddressesResponseMessage) error {
	var err *RPCError
