...
func (x *EiyaroMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "EiyaroMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *EiyaroMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
