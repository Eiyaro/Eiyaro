...
func (x *EiyaroMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "EiyaroMessage_Addresses is nil")
	}
...
func (x *EiyaroMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
