...
func (x *EiyaroMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "EiyaroMessage_Version is nil")
	}
...
func (x *EiyaroMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
