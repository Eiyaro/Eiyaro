...
func (x *EiyaroMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "EiyaroMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *EiyaroMessage_RequestPruningPointUTXOSet) fromAppMessage(
