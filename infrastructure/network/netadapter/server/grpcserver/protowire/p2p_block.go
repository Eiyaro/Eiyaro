...
func (x *EiyaroMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "EiyaroMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *EiyaroMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
