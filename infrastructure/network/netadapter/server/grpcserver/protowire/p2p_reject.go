...
func (x *EiyaroMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "EiyaroMessage_Reject is nil")
	}
...
func (x *EiyaroMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
