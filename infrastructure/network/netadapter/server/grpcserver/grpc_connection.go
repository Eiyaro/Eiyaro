...
type grpcStream interface {
	Send(*protowire.EiyaroMessage) error
	Recv() (*protowire.EiyaroMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.EiyaroMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.EiyaroMessage) error {
