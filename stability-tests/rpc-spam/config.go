...
type configFlags struct {
	...
	RPCAddress       string        `long:"rpc-address" description:"RPC address of the Eiyaro node"`
	StartNode        bool          `long:"start-node" description:"Start a temporary Eiyaro node for the test (devnet)"`
