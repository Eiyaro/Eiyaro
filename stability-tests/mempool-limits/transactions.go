...
import (
	...
	utxopkg "github.com/Eiyaro/Eiyaro/domain/consensus/utils/utxo"
...
const (
	payAddress                       = "hoosatsim:qzuax2jhawd354e54thhpd9m9wg03pdzwjlpr4vtq3k7xrpumhhtwa2hkr3ep"
...
func mineBlockAndGetCoinbaseTransaction(t *testing.T, rpcClient *rpcclient.RPCClient) *externalapi.DomainTransaction {
	...
	templateBlock, err := appmessage.RPCBlockToDomainBlock(getBlockTemplateResponse.Block, "MINE_BLOCK_POW_HASH")
	if err != nil {
