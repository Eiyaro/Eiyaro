...
type MergeDepthManager interface {
	CheckBoundedMergeDepth(stagingArea *StagingArea, blockHash *externalapi.DomainHash, ghostdagData *externalapi.BlockGHOSTDAGData, header externalapi.BlockHeader, isBlockWithTrustedData bool) error
