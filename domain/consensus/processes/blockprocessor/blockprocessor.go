...
import (
	...
	"github.com/Eiyaro/Eiyaro/domain/consensus/processes/blockprocessor/blocklogger"
...
func (bp *blockProcessor) ValidateAndInsertBlock(block *externalapi.DomainBlock,
	...
	return bp.validateAndInsertBlock(stagingArea, block, false, shouldValidateAgainstUTXO, false, false, powSkip)
}
