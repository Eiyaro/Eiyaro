...
import (
	...
	"github.com/Eiyaro/Eiyaro/domain/consensus/utils/blockheader"
	...
	"github.com/Eiyaro/Eiyaro/domain/consensus/utils/merkle"
...
func TestPOW(t *testing.T) {
	...
	testutils.ForAllNets(t, false, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		err = tc.ValidateAndInsertBlock(invalidBlockWrongPOW, true, true)
		...
		err = tc.ValidateAndInsertBlock(abovePowMaxBlock, true, true)
		...
		err = tc.ValidateAndInsertBlock(negativeTargetBlock, true, true)
		...
		if consensusConfig.Name != "hoosat-mainnet" {
			...
			err = tc.ValidateAndInsertBlock(validBlock, true, true)
			if err != nil {
				t.Fatal(err)
			}
		}
...
func TestCheckParentHeadersExist(t *testing.T) {
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		err = tc.ValidateAndInsertBlock(orphanBlock, true, true)
		...
		err = tc.ValidateAndInsertBlock(invalidBlock, true, true)
		...
		err = tc.ValidateAndInsertBlock(invalidBlockChild, true, true)
...
func TestCheckPruningPointViolation(t *testing.T) {
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		err = tc.ValidateAndInsertBlock(blockWithPruningViolation, true, true)
