...
var unOrderedParentsBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0xde, 0x08, 0x0f, 0x36, 0x78, 0xe4, 0x1b, 0x4a,
			0xad, 0xd0, 0x58, 0xba, 0xca, 0x09, 0xef, 0x05,
			0x9f, 0xd9, 0x80, 0x88, 0x39, 0x6d, 0x46, 0xd5,
			0xc6, 0x6b, 0x41, 0x93, 0xa6, 0xfb, 0xec, 0xaa,
		}),
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
...
var exampleValidBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0xf8, 0xdd, 0x51, 0xa8, 0x94, 0x8c, 0x58, 0x18,
			0xc4, 0xbe, 0xd7, 0x66, 0x11, 0x5e, 0x0c, 0xe2,
			0x09, 0xde, 0xd7, 0xb9, 0x58, 0x07, 0xc0, 0x56,
			0x80, 0x46, 0x79, 0x35, 0x59, 0x7c, 0x5a, 0x00,
		}),
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
...
var blockWithWrongTxOrder = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0x46, 0x14, 0x04, 0x93, 0xca, 0x61, 0x03, 0x42,
			0x6f, 0xce, 0x9c, 0x0d, 0x2a, 0xa4, 0x8f, 0xad,
			0x6a, 0xcf, 0x8c, 0x90, 0x4a, 0x26, 0x21, 0xa6,
			0x0c, 0x2d, 0xd5, 0xee, 0xc3, 0xe5, 0xf3, 0xc3,
		}),
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
