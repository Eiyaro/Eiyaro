...
// CalculateProofOfWorkValue computes the PoW using NogoPow algorithm.
...
// toBig converts a DomainHash into a big.Int treated as a little-endian string.
...
// BlockLevel returns the block level of the given header using NogoPow PoW value.
