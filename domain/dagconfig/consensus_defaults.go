...
const (
	...
	defaultSubsidyGenesisReward                    = 8 * constants.SeyPerEY
	// Eiyaro: Pre-deflationary phase with 8 EY base reward
	// This phase lasts until DAA score reaches defaultDeflationaryPhaseDaaScore
	defaultPreDeflationaryPhaseBaseSubsidy         = 8 * constants.SeyPerEY
	// Eiyaro: Deflationary phase starts with 8 EY and reduces by 10% annually
	defaultDeflationaryPhaseBaseSubsidy            = 8 * constants.SeyPerEY
	// Eiyaro: 10% annual reduction rate (gentler curve)
	defaultDeflationaryPhaseCurveFactor            = 1
	...
	// Eiyaro: 20 seconds block time
	defaultTargetTimePerBlock = 20 * time.Second
	...
	// Eiyaro: Minimum subsidy floor of 0.1 EY
	defaultMinimumSubsidy = 0.1 * constants.SeyPerEY
