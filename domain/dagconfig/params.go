...
import (
	...
	"github.com/Eiyaro/Eiyaro/util/network"
...
// Params defines a Eiyaro network by its parameters. These parameters may be
// used by Eiyaro applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/eiyaro-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/eiyaronet/research/issues/3
...
// MainnetParams defines the network parameters for the main Eiyaro network.
var MainnetParams = Params{
	K:           []externalapi.KType{defaultGHOSTDAGK},
	Name:        "eiyaro-mainnet",
	...
	TargetTimePerBlock:              []time.Duration{defaultTargetTimePerBlock},
	FinalityDuration:                []time.Duration{defaultFinalityDuration},
	DifficultyAdjustmentWindowSize:  []int{defaultDifficultyAdjustmentWindowSize},
	TimestampDeviationTolerance:     defaultTimestampDeviationTolerance,
	POWScores:                       []uint64{math.MaxUint64},
	PruningMultiplier:               []uint64{1},
	...
	MaxBlockParents:                         []externalapi.KType{defaultMaxBlockParents},
	...
	MaxBlockLevel: 225,
	MergeDepth:    []uint64{defaultMergeDepth},
}

// TestnetParams defines the network parameters for the test Eiyaro network.
var TestnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixEiyaroTest,
...
// SimnetParams defines the network parameters for the simulation test Eiyaro
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixEiyaroSim,
...
// DevnetParams defines the network parameters for the development Eiyaro network.
...
// ErrDuplicateNet describes an error where the parameters for a Eiyaro
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Eiyaro network")

var registeredNets = make(map[appmessage.EiyaroNet]struct{})

// Register registers the network parameters for a Eiyaro network. This may
