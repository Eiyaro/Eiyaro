...
import (
	...
	"github.com/Eiyaro/Eiyaro/domain/miningmanager/blocktemplatebuilder"
	mempoolpkg "github.com/Eiyaro/Eiyaro/domain/miningmanager/mempool"
)
...
func (f *factory) NewMiningManager(consensusReference consensusreference.ConsensusReference, params *dagconfig.Params,
	mempoolConfig *mempoolpkg.Config,
) MiningManager {
