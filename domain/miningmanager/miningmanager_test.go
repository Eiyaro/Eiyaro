...
import (
	...
	"github.com/Eiyaro/Eiyaro/domain/consensusreference"
	"github.com/Eiyaro/Eiyaro/domain/miningmanager/model"
	...
	"github.com/Eiyaro/Eiyaro/domain/consensus/utils/transactionhelper"
	"github.com/Eiyaro/Eiyaro/domain/consensus/utils/txscript"
	"github.com/Eiyaro/Eiyaro/domain/consensus/utils/utxo"
	"github.com/Eiyaro/Eiyaro/domain/miningmanager"
...
func TestModifyBlockTemplate(t *testing.T) {
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		for i := externalapi.KType(0); i < consensusConfig.K[constants.GetBlockVersion()-1]-2; i++ {
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libeiyarowallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
