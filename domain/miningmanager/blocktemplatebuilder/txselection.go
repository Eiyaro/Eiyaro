...
import (
	...
	consensusexternalapi "github.com/Eiyaro/Eiyaro/domain/consensus/model/externalapi"
...
//    (candidateTx.Value^alpha) / -(tx.Value^alpha)
...
// * Draw a number in [0,-(tx.Value^alpha)) to avoid normalization
